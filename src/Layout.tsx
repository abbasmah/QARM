...
const pageMeta: Record<string, PageMetaData> = {
  ...
  '/industries': { title: 'QARM Industries | Mortgage, Real Estate, Financial Services & Professional Services', description: "QARM's operating model — CRM automation, growth support, sales coordination, and managed operations — built for mortgage and extended across real estate, financial services, and professional services.", keywords: 'operations support industries, mortgage operations, real estate operations, financial services operations, professional services operations' },
  '/financial-services': { title: 'QARM Financial Services & Insurance | CRM, Policy & Client Support', description: 'QARM provides CRM management, policy and file coordination, client communication, and follow-up for financial advisors and insurance agents.', keywords: 'financial services operations support, insurance agency support, advisor CRM management, policy coordination, insurance back office' },
};
